...
Insert into SYS.DUC$ (OWNER,PACK,PROC,FIELD1,OPERATION#,SEQ,COM) values ('SYS','DBMS_IJOB','DROP_USER_JOBS','0','1','1','Drop all jobs with this LOG_USER, PRIV_USER or SCHEMA_USER');
